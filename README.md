# difish — 小鲸鱼桌面版 🐟
**本人是大一新生，计算机小白，接触agent才两周左右，诸多不足都可以提出来，目前还在摸索阶段
**这是一个早期版本，基本上是dsh的白板桌面端。起因是个人在使用dsh时觉得网页端有些麻烦，不够个性化，就心血来潮做个桌面端。后又刷到b站“ai猫娘”计划，就干脆将此做个跳板，日后自己做个桌面小鲸鱼，目前正在努力开发。
